...
const ScrollableDiv = () => {
    return (
        <div className="h-screen flex items-center justify-center">
            <div className="overflow-y-scroll h-full w-full   p-8">
                {/* Add your elements here */}

                <div className='bg-white h-48 w-full rounded-3xl my-4'>
                    <div className='flex flex-row h-12 border w-full bg-blue-200 border-black px-6 items-center justify-between'>
                    ...
                    <div className='flex flex-col h-36 w-full  rounded-b-3xl  bg-gray-200 border border-black'>
                        <div className='h-3/4 w-full flex flex-row justify-between px-8 items-center '>
                            
                            <h1 className='text-4xl font-bold'>Pune</h1>
                            <h1 className='text-4xl font-bold'>---8h---</h1>
                            <h1 className='text-4xl font-bold'>Mumbai</h1>
                        </div>
                        <div className='h-1/4 w-full flex flex-row justify-between px-8 items-center pb-12 '>
